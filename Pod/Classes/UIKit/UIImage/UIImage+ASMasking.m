...
#import "UIImage+ASMasking.h"


@implementation UIImage (ASMasking)

- (UIImage *)as_maskWithImage:(UIImage*)maskImage
{
	...
	CGContextRef bmContext = ASCreateARGBBitmapContext(originalWidth, originalHeight, 0, YES);
	if (!bmContext)
		return nil;
