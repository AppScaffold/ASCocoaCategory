...
CGContextRef ASCreateARGBBitmapContext(const size_t width, const size_t height, const size_t bytesPerRow, BOOL withAlpha)
{
	...
	CGContextRef bmContext = CGBitmapContextCreate(NULL, width, height, 8/*Bits per component*/, bytesPerRow, ASGetRGBColorSpace(), kCGBitmapByteOrderDefault | alphaInfo);
